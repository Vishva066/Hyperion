...
contract EnergyTrade {
    ...
    function createOffer(uint256 _quantity, uint256 _pricePerUnit,uint256 _minQuantity, uint256 _duration) public {
    ...
    function getallBids(uint _offerId) public view returns (Bid[] memory) {
       return bids[_offerId];
    }
    ...
    function placeBid(uint256 _offerId, uint256 _quantity, uint256 _pricePerUnit, bool _active) public {
        ...
        require(offers[_offerId].minQuantity <= _quantity, "It is less than the minimum qanity of ");
    ...
    function selectBestBid(uint256 _offerId) public payable {
    ...
    function selectAnyBid(uint256 _offerId, uint256 _bidindex) public payable {
        Offer storage offer = offers[_offerId];
        
        Bid storage bestBid = bids[_offerId][_bidindex];
        require(bestBid.active, "Bid is not active");
